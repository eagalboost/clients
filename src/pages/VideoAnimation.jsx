...
const VideoAnimation = () => {
  ...
  return (
    <div>
      <Hero
        bloomColor1="rgba(255, 95, 31, 0.8)"
      ...
      />
      <div>
        <h2 className="text-white font-roboto text-center text-2xl lg:text-3xl font-bold mt-4 border-b-2 border-[#333333] w-[max-content] mx-auto pb-1">
