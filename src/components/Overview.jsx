    ...
    <section className="w-full h-full text-white flex justify-center">
      <div className="w-full max-w-6xl p-4 grid grid-cols-1 gap-8">
        <div className="text-center flex flex-col justify-center items-center">
          ...
          <p className="text-xl md:text-2xl font-openSans text-primaryText mb-2">
            {username ? `${username}` : "Loading username..."}
          </p>
          <p className="text-xl md:text-2xl font-openSans text-primaryText">
            {greeting}
          </p>
        </div>
...
const Card = ({ count, label }) => (
  <div
    className="col-span-1 p-8 rounded-lg shadow-lg max-h-[300px] text-center relative overflow-hidden"
    style={{
  ...
  >
    ...
    <h2 className="relative z-10 text-3xl md:text-5xl font-bold mb-2 font-roboto text-primaryText">
      {count}
    </h2>
    <p className="relative z-10 text-lg md:text-xl font-semibold font-openSans text-primaryText">
      {label}
    </p>
  </div>
);
