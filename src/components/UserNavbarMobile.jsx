          ...
          <ul className="flex flex-col">
            <li className="border-b border-[#444444] pb-2">
              ...
              >
                <img
                  ...
                  className="w-12 h-12"
                />
                <p className="font-openSans text-primaryText">
            ...
            <li>
              <Link
                to="/billing"
                onClick={closeMenu}
                className="flex items-center justify-center font-openSans text-primaryText hover:text-primaryRgb transition-colors duration-300 border-b border-[#444444] py-3 font-medium"
              >
                Billing & Payments
              </Link>
            </li>
            ...
            <li className="flex items-center justify-center">
              <button
                onClick={logout}
                className="font-openSans text-primaryText hover:text-primaryRgb transition-colors duration-300 py-3 font-medium"
              >
                Logout
              </button>
            </li>
